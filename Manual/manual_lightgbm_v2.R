...
source("/home/tli/projects/ShinyMLHome/global.R")
setwd(proj_dir)
...
rm(km_tgt, aggr_predictors_ohe_scaled)
gc()
...
##
# Predict
val_prdctrs_sltd <- val_predictors[, ]
val_tgts <- val_target
gc()
...
if(TRUE){
  ...
  test_prdctrs_sltd <- prdctrs_test$coredata[, top_feats_all[1:500]]
  rm(prdctrs_test)
  gc()
